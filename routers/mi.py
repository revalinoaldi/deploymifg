...
def auth_login():
    ...
    if get_auth is None:
        ...
        r = requests.post('https://development.inhealth.co.id/intracoins_services/api/authentication/login', json=payload, headers=headers)
        r = r.text
...
def upload_spaj(req: UploadFileSPAJ):
    msg = "success"
    r=[]
    FILE_HOST = '/var/www/ifgl_frontend/frontend/web/uploads/'
    try:
        r = auth_login()
        r = json.loads(r)
